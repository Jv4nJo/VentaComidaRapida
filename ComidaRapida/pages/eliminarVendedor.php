...
<body>
    ...
    <div class="container mt-4">
        <div class="row">
            <form action="../transacciones/eliminarVendedor.php" method="POST">
                <div class="container mt-3">
                    <div class="row mt-3">
                        <input type="hidden" name="id" value="<?php echo $vendedor->id; ?>" />
                        <h2 class="text-center text-danger">¿Está seguro que desea eliminar al vendedor: <?php echo $vendedor->nombre; ?>?</h2>
                    </div>

                    <div class="row mt-4">
                        <div class="col-12 text-center">
                            <input type="submit" class="btn btn-danger" value="Eliminar vendedor" />
                            <a href="./vendedores.php" class="btn btn-dark"><i class="fa fa-reply" aria-hidden="true"></i>
                                Volver
                            </a>
                        </div>
                    </div>
